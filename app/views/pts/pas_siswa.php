        ...
        <div class="container">
            <div class="flex flex-wrap mb-[61px] lg:mb-24">
                <div class="w-full self-center px-4 lg:w-1/2 lg:pl-20">
                    <h2 class="font-semibold text-xl text-primary lg:text-2xl"> Penilaian </h2>
                    <h1 class="font-bold text-5xl mb-2 lg:text-6xl"> Akhir </h1>
                    <h2 class="font-semibold text-base text-secondary lg:text-lg uppercase">Semester <?php echo $data['kelas'] ?> </h2>
                </div>
                <div class="w-full self-center px-4 mt-20 flex justify-center items-center flex-col md:w-1/2 lg:w-1/2">
                <form action="<?php echo BASEURL; ?>/public/pts/tambahNilaiAkhir/<?php echo $data['kelas'] ?>" method="post"> 
