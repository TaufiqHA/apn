        ...
        <div class="container">
            <div class="flex flex-wrap mb-[61px] lg:mb-24">
                <div class="w-full self-center px-4 lg:w-1/2 lg:pl-20">
                    <h2 class="font-semibold text-xl text-primary lg:text-2xl"> Form </h2>
                    <h1 class="font-bold text-5xl mb-2 lg:text-6xl"> Tugas </h1>
                ...
                <form action="<?php echo BASEURL; ?>/public/tugas/tambahNilai/<?php echo $data['kelas'] ?>" method="post"> 
                     <label for="tugas">Tugas ke:</label>
                    <select name="tugas" id="tugas" class="mb-5 bg-transparent">
