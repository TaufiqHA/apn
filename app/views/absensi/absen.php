            ...
            <div class="flex flex-wrap mb-[61px] lg:mb-24">
                ...
                <div class="w-full self-center px-4 mt-20 md:w-1/2 lg:w-1/2 flex flex-col items-center">
                    ...
                    <div class="flex justify-center">
                        <button class="font-bold text-white flex justify-center items-center mt-20 text-center w-[246px] h-[47px] bg-teal-500 rounded-full shadow-lg shadow-slate-300 hover:scale-110 transition duration-300" type="submit">TAMBAH SISWA</button>
                    </div>
                </form>
                </div>
             </div>
